...
import runner.server.command.CommandProvider;
import runner.server.command.exception.CommandException;
import runner.server.command.impl.DisconnectCommand;
...
public class Connect extends Thread {
    ...
    public void run() {
        ...
        sendMessage("""
                Please specify the command number:
                [1] Authorize as user or manager
                [2] Disconnect from server
                [3] View data
                [4] Create user with credentials
                [5] Edit user (needed id!)
                ***Powered by amarjin6***
                """);
